<?php 
include 'koneksi.php'; // Memanggil file koneksi yang telah dibuat 
            ...
            <tbody> 
                ...
                if ($result->num_rows > 0) { 
                    ...
                    while ($row = $result->fetch_assoc()) { 
                        ...
                        echo "<a href='delete.php?id=" . $row['id'] . "' class='btn-delete' onclick='return confirm(\"Apakah Anda yakin ingin menghapus data ini?\")'>Delete</a>"; 
                        echo "</td>"; 
                        echo "</tr>"; 
                    } 
                } else { 
...
<button type="submit">Download Report PDF</button>
        ...
        <a href="tambah_mahasiswa.php" target="_blank" class="btn-tambah">Tambah</a>
